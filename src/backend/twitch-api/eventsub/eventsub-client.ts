...
class TwitchEventSubClient {
    ...
    async createClient(): Promise<void> {
        ...
        try {
            ...
            // First time subs
            // const subsSubscription = await this._eventSubListener.subscribeToChannelSubscriptionEvents(streamer.userId, (event) => {
                ...
                // }
            // });
            // this._subscriptions.push(subsSubscription);
    
            // Gift subs
            // const giftSubsSubscription = await this._eventSubListener.subscribeToChannelSubscriptionGiftEvents(streamer.userId, (event) => {
                
            // });
            // this._subscriptions.push(giftSubsSubscription);
    
            // this._subscriptions
            // const subsSubscription = await this._eventSubListener.subscribeToChannelSubscriptionMessageEvents(streamer.userId, (event) => {
