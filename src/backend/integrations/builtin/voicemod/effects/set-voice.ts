...
export const SetVoiceEffectType: EffectType<{
    ...
    <eos-container header="Voicemod Voice">
        ...
        <div class="effect-info alert alert-warning">
          Note: Because of the way VoiceMod works, for best performance and stability it is recommended you place other VoiceMod effects you need(i.e. "Toggle Voice Changer") before this effect.
        </div>
    </eos-container>
  `,
